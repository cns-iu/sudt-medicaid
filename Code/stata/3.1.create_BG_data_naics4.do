...
// Converting csv files to BG county stata files
	...
	// using naics4 filter 
	import delimited "/Box/thdnguye/SUDT_DataSet/BGT Extract NAICS4/naics4 original/job-year-state-naics4.csv",  clear
	ren count count_SUD
	sum count_SUD
	dis r(sum)
	...
	clear
	import delimited "/Box/thdnguye/SUDT_DataSet/BGT Extract NAICS4/naics4 original/occupation-naics4-year-state.csv",  clear
...
save  "${finaldatadir}/AllpostSUDState2010_2018_compiled_naics4.dta",replace
