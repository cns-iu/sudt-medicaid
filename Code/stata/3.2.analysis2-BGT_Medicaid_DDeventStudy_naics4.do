...
use "${finaldatadir}/AllpostSUDState2010_2018_compiled_naics4.dta",clear
	drop if year==2009
// events
...
// treatment and control groups: expansion_post
	...
	save "${finaldatadir}/AllpostSUDState2010_2018_compiled_events_naics4.dta",replace
	...
	use "${finaldatadir}/AllpostSUDState2010_2018_compiled_events_naics4.dta",clear
	xtset st_fips year
...
coefplot (SUDL1 )  (OutpatientL1 )  (ResidentialL1 )  (HospitalL1 )  (PsychologistL1 ) ///
	...
	graph export "${plotdir}/figure_4_BG_Medicaid_SUDT_naics4.tif" ,  replace	 width(2000)
	graph export "${plotdir}/figure_4_BG_Medicaid_SUDT_naics4.png" ,  replace	 width(4000)	
